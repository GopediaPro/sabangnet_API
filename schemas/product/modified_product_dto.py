...
class ModifiedProductDataDto(BaseModel):
    ...
    img_path6: Optional[str] = Field(None, description="부가이미지6")
    img_path7: Optional[str] = Field(None, description="부가이미지7")
    img_path8: Optional[str] = Field(None, description="부가이미지8")
    img_path9: Optional[str] = Field(None, description="부가이미지9")
    img_path10: Optional[str] = Field(None, description="부가이미지10")
    img_path11: Optional[str] = Field(None, description="부가이미지11")
    img_path12: Optional[str] = Field(None, description="부가이미지12")
    img_path13: Optional[str] = Field(None, description="부가이미지13")
    img_path14: Optional[str] = Field(None, description="부가이미지14")
    img_path15: Optional[str] = Field(None, description="부가이미지15")
    img_path16: Optional[str] = Field(None, description="부가이미지16")
    img_path17: Optional[str] = Field(None, description="부가이미지17")
    img_path18: Optional[str] = Field(None, description="부가이미지18")
    img_path19: Optional[str] = Field(None, description="부가이미지19")
    img_path20: Optional[str] = Field(None, description="부가이미지20")
    img_path21: Optional[str] = Field(None, description="부가이미지21")
    img_path22: Optional[str] = Field(None, description="부가이미지22")
