...
class ModifiedProductDataDto(BaseModel):
    ...
    # 분류·구분 코드
    goods_gubun: int = Field(..., ge=1, le=5, description="상품구분(1~4)")
    ...
    mall_gubun: Optional[str] = Field(None, max_length=10, description="몰구분")
    ...
    img_mall_jpg: Optional[str] = Field(None, description="몰 전용 JPG")
    img_add_2: Optional[str] = Field(None, description="추가이미지 2")
    img_add_3: Optional[str] = Field(None, description="추가이미지 3")
    img_add_4: Optional[str] = Field(None, description="추가이미지 4")
    img_add_5: Optional[str] = Field(None, description="추가이미지 5")
    img_add_6: Optional[str] = Field(None, description="추가이미지 6")
    img_add_7: Optional[str] = Field(None, description="추가이미지 7")
    img_add_8: Optional[str] = Field(None, description="추가이미지 8")
    img_add_9: Optional[str] = Field(None, description="추가이미지 9")
    img_add_10: Optional[str] = Field(None, description="추가이미지 10")
    img_add_11_list: Optional[str] = Field(None, description="추가이미지 11(목록)")
    img_add_12: Optional[str] = Field(None, description="추가이미지 12")
    img_add_13: Optional[str] = Field(None, description="추가이미지 13")
    img_add_14: Optional[str] = Field(None, description="추가이미지 14")
    img_add_15: Optional[str] = Field(None, description="추가이미지 15")
    img_add_16: Optional[str] = Field(None, description="추가이미지 16")
    img_add_17: Optional[str] = Field(None, description="추가이미지 17")
    img_add_18: Optional[str] = Field(None, description="추가이미지 18")
    img_add_19: Optional[str] = Field(None, description="추가이미지 19")
    img_add_20: Optional[str] = Field(None, description="추가이미지 20")
    img_add_21: Optional[str] = Field(None, description="추가이미지 21")
    img_add_22: Optional[str] = Field(None, description="추가이미지 22")
    cert_img: Optional[str] = Field(None, description="인증서 이미지")
    import_cert_img: Optional[str] = Field(None, description="수입증명 이미지")
