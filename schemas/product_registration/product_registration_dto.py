...
class ProductRegistrationCreateDto(BaseModel):
    ...
    img_mall_jpg: Optional[str] = Field(None, description="부가이미지1 (종합몰이미지_jpg)")
    img_add_2: Optional[str] = Field(None, description="부가이미지2")
    img_add_3: Optional[str] = Field(None, description="부가이미지3")
    img_add_4: Optional[str] = Field(None, description="부가이미지4")
    img_add_5: Optional[str] = Field(None, description="부가이미지5")
