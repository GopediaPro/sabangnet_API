...
class ProductMycategoryData(Base):
    ...
    # 기본 정보
    class_cd1: Mapped[str] = mapped_column(
        String(50), comment="대분류_분류코드"
    )
    class_nm1: Mapped[str] = mapped_column(
        String(50), comment="대분류_분류명"
    )
    class_pr1: Mapped[str] = mapped_column(
        String(50), comment="대분류_전시순서"
    )
    class_cd2: Mapped[str] = mapped_column(
        String(50), comment="중분류_분류코드"
    )
    class_nm2: Mapped[str] = mapped_column(
        String(50), comment="중분류_분류명"
    )
    class_pr2: Mapped[str] = mapped_column(
        String(50), comment="중분류_전시순서"
    )
    class_cd3: Mapped[str] = mapped_column(
        String(50), comment="소분류_분류코드"
    )
    class_nm3: Mapped[str] = mapped_column(
        String(50), comment="소분류_분류명"
    )
    class_pr3: Mapped[str] = mapped_column(
        String(50), comment="소분류_전시순서"
    )
    class_cd4: Mapped[str] = mapped_column(
        String(50), comment="세분류_분류코드"
    )
    class_nm4: Mapped[str] = mapped_column(
        String(50), comment="세분류_분류명"
    )
    class_pr4: Mapped[str] = mapped_column(
