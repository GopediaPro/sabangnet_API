...
class ProductRawData(Base):
    ...
    img_mall_jpg: Mapped[str] = mapped_column(Text)
    img_add_2: Mapped[str | None] = mapped_column(Text)
    img_add_3: Mapped[str] = mapped_column(Text)
    img_add_4: Mapped[str | None] = mapped_column(Text)
    img_add_5: Mapped[str | None] = mapped_column(Text)
    img_add_6: Mapped[str | None] = mapped_column(Text)
    img_add_7: Mapped[str | None] = mapped_column(Text)
    img_add_8: Mapped[str | None] = mapped_column(Text)
    img_add_9: Mapped[str | None] = mapped_column(Text)
    img_add_10: Mapped[str | None] = mapped_column(Text)
    img_add_11_list: Mapped[str | None] = mapped_column(Text)
    img_add_12: Mapped[str | None] = mapped_column(Text)
    img_add_13: Mapped[str | None] = mapped_column(Text)
    img_add_14: Mapped[str | None] = mapped_column(Text)
    img_add_15: Mapped[str | None] = mapped_column(Text)
    img_add_16: Mapped[str | None] = mapped_column(Text)
    img_add_17: Mapped[str | None] = mapped_column(Text)
    img_add_18: Mapped[str | None] = mapped_column(Text)
    img_add_19: Mapped[str | None] = mapped_column(Text)
    img_add_20: Mapped[str | None] = mapped_column(Text)
    img_add_21: Mapped[str | None] = mapped_column(Text)
    img_add_22: Mapped[str | None] = mapped_column(Text)
