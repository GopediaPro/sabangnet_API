...
class BrandiERP:
    ...
    def step_1_to_10(self) -> str:
        print("브랜디 ERP 자동화 1~10단계 처리 시작...")
        self._step_10() # 10단계 정렬 먼저 후 적용
        self._step_1()
        self._step_2()
        self._step_3()
        self._step_4()
...
def brandi_erp_macro_1_to_10(file_path):
    ...
    """
    brandi = BrandiERP(file_path)
    output_path = brandi.step_1_to_10()
