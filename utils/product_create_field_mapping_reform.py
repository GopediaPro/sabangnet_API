PRODUCT_CREATE_FIELD_MAPPING = {
        ...
        "속성값32": "PROP_VAL32",
        "속성값33": "PROP_VAL33",
        # "속성값34": "PROP_VAL28", -> 디자인업무일지 O 명세서 X
        # "속성값35": "PROP_VAL29", -> 디자인업무일지 O 명세서 X
        # "속성값36": "PROP_VAL30", -> 디자인업무일지 O 명세서 X
        # "속성값37": "PROP_VAL31", -> 디자인업무일지 O 명세서 X
        # "속성값38": "PROP_VAL32", -> 디자인업무일지 O 명세서 X
